...
<table align="center" style="width: 900px">
	<tr>
		<td class="h2">
			Front Panel Layout
			and Descriptions For The Version 1 of&nbsp; Gemini-2</td>
	</tr>
	<tr>
...
<table align="center" style="width: 900px">
	...
	fresh.&nbsp; It is a&nbsp; CR2354 which are sometimes hard to find, so take the time and order a couple now.&nbsp; 
...
use, or click on a connector to be taken to the description of that connector.
	The bottom paragraph gives some important information on the internal battery.</td> </tr>
</table>
<table align="center" style="width: 900px">
	<tr>
		<td class="style7">
		...
		<map id="ImgMap0" name="ImgMap0">
			<area alt="" coords="613, 240, 724, 412" href="#Top_Power_jack_and_Bottom_Power_jack" shape="rect" />
			<area alt="" coords="716, 740, 845, 913" href="#Autoguider_input" shape="rect" />
			<area alt="" coords="573, 1097, 671, 1192" href="#USB_port" shape="rect" />
			<area alt="" coords="400, 1061, 552, 1195" href="#Feature_Port" shape="rect" />
			<area alt="" coords="260, 1062, 387, 1195" href="#Ethernet_Port" shape="rect" />
			<area alt="" coords="31, 1004, 203, 1139" href="#Standard_Hand_controller" shape="rect" />
			<area alt="" coords="24, 402, 169, 574" href="#Serial_Port_2" shape="rect" />
			<area alt="" coords="27, 214, 170, 390" href="#Serial_Port_1" shape="rect" />
			<area coords="99, 69, 253, 193" href="#PortE" shape="rect" />
			<area alt="" coords="270, 77, 390, 190" href="#DEC_connector" shape="rect" />
			<area alt="" coords="616, 68, 736, 182" href="#RA" shape="rect" />
			<area alt="" coords="458, 594, 588, 666" href="#USB-A" shape="rect" />
		</map>
		<!--<a href="gemini-images/Frontpanel/Gemini-2_Front_Panel_pinouts.jpg" target="_blank">-->
		
		<img alt="" height="1243" src="gemini-images/Frontpanel/Gemini-2_Front_Panel_pinouts_900.jpg" width="900" usemap="#ImgMap0"  /><br />
		Fig 1.
		</td>
	</tr>
		...
		<br />Jack (Jack Socket) descriptions: Going clockwise from top Left.
		<br />
						<ul>
				...
				Battery/Ports page</a>).&nbsp;
				<!--<br /> <span class="auto-style5">However the External encoders that Losmandy used to sell 
				are to low of a resolution to be useful, so the encoder function 
				is not implemented in the firmware at this time.</span>-->Serial 
				commands 14 and 15 used to enable or disable these inputs 
				respectively.</li>
			...
			<ul>
				...
				pin-outs.&nbsp; PLEASE DO NOT CONNECT or DISCONNECT the MOTOR 
				CONNECTORS with the top panel removed.&nbsp; The top panel provides 
				the necessary support to keep these connectors from cracking a 
				connector pin from cable strain.</li>
			</ul>
			<ul>
				<li><strong><em><a name="RA">RA</a></em></strong> - this is to the RA motor on the telescope. This will be the bottom motor. 
				The wiring is the same as the Gemini-1 with Din connectors.&nbsp; 
				See page 130 of the
				<a href="/downloads/pdf/GeminiL4UserManual.pdf" target="_blank">
				Level 4 manual</a> for a description of the pin-outs.&nbsp; PLEASE DO 
				NOT CONNECT or DISCONNECT the MOTOR CONNECTORS with the top 
				panel removed.&nbsp; The top panel provides the necessary support 
				to keep these connectors from cracking a connector pin or PCB 
				connection.</li>
			</ul>
			<ul>
				<li><strong><em><a name="Top_Power_jack_and_Bottom_Power_jack">Top Power jack and Bottom Power jack</a></em></strong> - 
				(There is only one power jack on the new version of the 
				Gemini-2) these jacks are in 
				parallel and either can be used as input. The only thing is that 
				each has a 5 Amp fuse in-line before they are tied together 
				inside the Gemini-2. The second is used to 
				help provide power to accessories.&nbsp; The center pin is 
				positive. They are 2.1mm/5.5mm size connectors. I recommend 5 
				...
				leads. The panel inputs are in 
				parallel, but do have a 5 Amp Fuse and protection diode so that the wrong 
				polarity will not damage anything inside the Gemini 2, but it 
				could damage any accessory you have connected, to the other 
				jacks. I recommend a CINCON Medical Power supply 90-267V AC 
				...
				recommend 12-18V DC range recommended by Losmandy. Please note 
				that if you use anything besides 12 Volts as power, the second 
				jack is going to put out the same voltage as the supply voltage,&nbsp; 
				I.E. 15V in will be 15V out on the other power connector.</li>
			</ul>
			<ul>
			...
			<ul>	<li><strong><em><a name="USB_port">USB port</a></em></strong> - this is the USB port that you will use (the USB-A 
				port in the center of the panel is not supported.). There are 
				...
				but surely it can be done, if there are reasons to do this.
				</li>
				<li>
			...
			<ul>
				<li><strong><em><a name="Feature_Port">Feature Port</a></em></strong> or Port F- This is an expansion port.&nbsp; The signals 
				on this port 
			...
			<ul>
				...
				Gemini-2 or Gemini-2 Mini is connected via Ethernet and and your 
				...
				and is is only a 10/100Mhz speed connection, then you are going to have to
				use a ethernet crossover cable.  I suggest you Google Ethernet crossover cable to 
				get more info.</li>
			</ul>
			<ul>
				<li><strong><em><a name="Standard_Hand_controller">Standard Hand controller</a></em></strong> - 
				(This connector is missing on the new version of the Gemini-2) this is the same hand controller 
				that is supplied with Losmandy's stepper motor mount controller 
				system, and was the first hand controller used with the Gemini-1.&nbsp; It can be ordered separately from Losmandy. Part 
				number HC.&nbsp; Note: this hand controller does not function 
				like the buttons on the Graphical hand controller front LCD.&nbsp; It 
				functions like the hand controller on the Gemini-1, or the 
				buttons on the back of the Gemini-2 hand controller.&nbsp; If you 
				need to speed up, you have to press the opposite button to the 
				one you pressed first (it must be held down also when pressing 
				the opposite button to change speed.)&nbsp; Each press of the 
				opposite button while holding down the desired directional 
				button should take you to the next 
				speed range.&nbsp; Guide--&gt;Center--&gt;Move--&gt;Slew.&nbsp; 
				You can see a picture of both versions
				<a href="ClassicHandController.php">here</a>.&nbsp; Losmandy has just introduced a newer 
				version using a membrane panel like on the back of the Gemini-2.&nbsp; 
				you can see a picture
				<a href="http://www.losmandy.com/hi-rez-images/492_HC_1.jpg" target="_blank">
				here</a>, and
				<a href="http://www.losmandy.com/replacement.html" target="_blank">
				here</a> is the order page. This is the
				<a href="https://groups.yahoo.com/neo/groups/Losmandy_users/files/controller.jpg" target="_blank">
				schematic</a> that is posted on the
				<a href="http://groups.yahoo.com/neo/groups/Losmandy_users/info" target="_blank">
				Losmandy users group</a> of the older model. &nbsp; This schematic is 
				on the Losmandy users group under files and is named 
				controller.jpg with a description of Hand controller.&nbsp;</li>
			</ul>
			<ul>
				<li><strong><em><a name="Serial_Port_2">Serial Port 2</a></em> - 
				THIS PORT IS NOT COMPATIBLE WITH THE GEMINI-1 SERIAL CABLE.</strong> (This port has been relabeled on the new version of the Gemini-2 
				...
				the same +\- 25 Voltage swing inputs on the serial pins and still be safe.<ul>
					...
					commerical product sold by another company.&nbsp; It is no 
					longer being manufactured.</li>
					<li>The Second Version is totally produced by Losmandy, 
					except for the LCD itself.&nbsp; Hopefully this version will be 
			...
			<ul>
				<li><strong><em><a name="Serial_Port_1">Serial Port 1</a></em> - 
				THIS PORT IS NOT COMPATIBLE WITH THE GEMINI-1 SERIAL CABLE.</strong>
				 (This jack is relabeled on the new version to Serial/GPS) This is the serial port that you normally 
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
		Please note that there is an internal CR2354 3 Volt 
		Lithium battery inside under the front cover.&nbsp;&nbsp;  Please see the 
		<a href="warning.php" target="_blank">Warning page</a> before changing&nbsp; of this battery. You can also see the battery voltage from the 
	...
	<tr>
		<td class="style7">
		Page last updated on Oct 14, 2016</td>
	</tr>
</table>

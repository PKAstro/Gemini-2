...
<table align="center" style="width: 900px">
	...
	<tr>
		...
		<img alt="" height="877" src="images/site-time.jpg" width="838" usemap="#ImgMap0" />
		</td>
	</tr> 
	<tr>
	...
	<tr>
		...
		<ul><li>Predefined Observation Sites - This lets you 
			...
			sites.&nbsp; You will also have to use "Select Site" to make sure 
			the one you want is the active site.</li>
			...
			changed.</li>&nbsp; See
			<a href="http://gemini-2.com/videos/MP4/setsiteweb.mp4" target="_blank">movie</a> on 
			changing them.
			<a href="http://gemini-2.com/web/images/SiteSet.jpg" target="_blank">Hand controller after 
			movie</a>.
			<ul>

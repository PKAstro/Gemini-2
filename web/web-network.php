...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area alt="" coords="15, 683, 74, 714" href="index.php" shape="rect" />
		</map>
		<img alt="" height="840" src="images/network-NTP.jpg" usemap="#ImgMap0" width="900" /></td>
	</tr> 
	<tr>
	...
	<tr>
		...
		<ol>
			...
			registry Patch to be able to act as a NPT time server.&nbsp; Please 
			see both <a href="web-NTP.php" target="_blank">NPT instructions</a> 
			and the <a href="web-site-time.php" target="_blank">Site/time</a> 
			page.</li>
			<li>

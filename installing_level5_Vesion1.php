...
<body style="color: #FFFFFF; background-color: #000000">
	...
	<table align="center" style="width: 900px">
		<tr>
			...
			go</span><a href="updateFileExplorer.php" target="_blank"> here</a>.</td></tr></table>
...
<table align="center" style="width: 900px">
		...
		<table align="center" style="width: 900px">
			<tr><td class="style6">
				...
				<a href="http://gemini-2.com/crossovernetwork.php" target="_blank">Windows and XP</a> 
		...
		<table align="center" style="width: 900px" class="tableborder1">
			...
			<a href="firmware1/NewGem-gem-hd-3-Oct-2013.zip" target="_blank">download the file.</a>&nbsp; Then unzip it to a clean directory,&nbsp; 
			...
			<a href="Newgem-gemhx-only/Newgem-gemhc-only.htm" target="_blank">
		...
		<tr>
			...
			you don't see <a href="ConnectingtoG2.php">connecting to Ethernet 
			port</a>.</td>
		</tr>
		<tr>
		...
		<tr><td class="style6"><br />I created a movie that demonstrates the 
			...
			<a href="GeminiFirmware_movie/gemini-firmware-upgrade.htm" target="_blank">Flash version</a>&nbsp; or a
			<a href="GeminiFirmware_movie/gemini-firmware-upgrade.exe" target="_blank">
			Windows.exe</a> 
	...
	<table align="center" style="width: 900px">
		...
		<tr>
			<td class="style6">
			29.  Now once you have the catalogs you want in the right menu, you can either turn off the Gemimi-2 and
...
-->
	<table align="center" style="width: 900px">
		<tr>
			<td>
<div class="AJXMenuSPDSMNA">
	<!-- AJXFILE:ajxmenu_bottom.css -->
 <div class="ajxmw1">
  <div class="ajxmw2">
<ul>
 <li class="tfirst tlast"><a href="index.php" target="_self">HOME</a></li>
</ul>
  </div>
 </div>
 <br />
...
<table style="width: 100%">
	<tr>
	<td class="style6R" width="45%">Hit counter &nbsp; </td>
		<td width="10%"><a href="http://www.digits.com" target="_blank">
    <img src="http://counter.digits.com/?counter={e8d13978-5089-2294-910b-65c8508b354e}&template=simple" 
     alt="Hit Counter by Digits" border="0"  />  </a></td>
		<td class="style6" align="left">  &nbsp;by  <a href="http://www.digits.com" target="_blank">Digits.com</a> 
		(installed Jan 2012)</td>
	</tr>
</table>
<!--
<table align="center" style="width: 100%">
	<tr>
		<td><a href="http://www.digits.com" target="_blank">
    <img src="http://counter.digits.com/?counter={e8d13978-5089-2294-910b-65c8508b354e}&template=simple" 
	...
	<tr >
		<td class="style7">Hit counter by <a href="http://www.digits.com" target="_blank">Digits.com</a></td>
	</tr>
</table>
 -->
...
<table align="center" cellpadding="4" cellspacing="4" style="width: 70%">
	<tr class="style6">
		<td class="style1"><a href="privacy.php" target="_blank">Privacy Policy</a></td>
	</tr>
	<tr class="style6">
		<td class="style1">All Content on this site is unofficial and not approved by Losmandy</td>
	</tr>
	<tr class="style6">
		<td class="style13"><b>Your use of any information on this site is at your own risk.</b></td>
	</tr>
	<tr class="style6">
		<td class="style1">Copyright&copy; - 2013-2012-2011 Thomas Hilton - 
		<a href="Http://www.Gemini-2.com">Http://www.Gemini-2.com</a> and
		<a href="Http://www.Gemini-2.com">Http://www.Gemini-1.com</a><br />
		<br />			Gemini-2 and Gemini is a registered trade names of Hollywood General Machining Inc.</td>
	</tr>
	<tr class="style6">
		<td class="style1">
		<!--<p align="center">Contact Web Master:</p>-->
		
	<p align="center"><!--webbot bot="HTMLMarkup" startspan --><script language=javascript>

	  <!--
	  var contact = "Contact Web Master"
	  var email = "tom"

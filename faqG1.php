...
<!--	<tr>
		<td class="style6">
		<a href="#Q1" >1.&nbsp;&nbsp;&nbsp;What does it take to add a second 
		communication port to the Gemini Controller?</a>
		</td>
	</tr>
-->
		<td class="style6">
		<a href="#Q1" >1.&nbsp;&nbsp;&nbsp;Warning about parking the mount and leaving power on.</a>
		</td>


	<tr>
		<td class="style6"><br />
		<a href="#Q2" >2.&nbsp;&nbsp;&nbsp;Why does the Gemini Stop and wait for startup 
		instructions if the hand controller is not present?</a>
		</td>
	</tr>

	<tr><br /><br />
		<td class="style6"><br />
			<a href="#Q3" >3.&nbsp;&nbsp;&nbsp;&nbsp;What is a ground loop and how can you test for 
			one?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q4" >4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;How do you disable the Gemini 
		modeling, to use T-Point or ACP</a>
		</td>
	</tr>

	<tr>
		<td class="style6"><br />
		<a href="#Q5" >5.&nbsp;&nbsp;&nbsp;&nbsp; Is it possible to use more than one 
		USB-serial adapter at one time on a laptop?</a>
		</td>
	</tr>

	<tr>
		<td class="style6"><br />
		<a href="#Q6" >6.&nbsp;&nbsp;&nbsp;&nbsp;How do you install the ASCOM Driver in 
		TheSKY6?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q7" >7.&nbsp;&nbsp;&nbsp;&nbsp;How do you determine the Com Port of a 
		connected USB to Serial Adapter and change it?</a>
		</td>
	</tr>

	<tr>
		<td class="style6"><br />
		<a href="#Q8" >8.&nbsp;&nbsp;&nbsp;&nbsp;What is the different between the old 
		and new autoguider ports?</a>
		</td>
	</tr>

	<tr>
		<td class="style6"><br />
		<a href="#Q9" >9.&nbsp;&nbsp;&nbsp;&nbsp;How do you get Windows 2000, XP, Vista 
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q10" >10.&nbsp;&nbsp;&nbsp;What are the changes between L4V1.02 and 
		L4V1.04 EPROMS?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q11" >11.&nbsp;&nbsp;&nbsp;How do you determine if the RS232 chip in 
		the Gemini is bad?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q12" class="style6-Yellow" >12.&nbsp;&nbsp;&nbsp;Can you run the Gemini without the motors 
		connected safely?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q13">13.&nbsp;&nbsp;&nbsp;What will cause the Gemini to shut down the hand controller 
		or not boot up?</a>
		</td>
	</tr>
	...
	<tr>
		<td class="style6"><br />
		<a href="#Q14" >14.&nbsp;&nbsp;&nbsp;What does the red dots on 
		the hand controller mean during boot?</a>
		</td>
	</tr>
	<tr>
		<td class="style6"><br />
		<a href="#Q15">15.&nbsp;&nbsp;&nbsp;How do you measure the CMOS RAM chip battery 
		voltage and partial schematic?</a>
		</td>
	</tr>

	<tr>
		<td class="style6"><br />
		<a href="#Q16">16.&nbsp;&nbsp;&nbsp;&nbsp;How should the guide cable from a 
		ShoeStringAstronomy GPUSB be wired for the Gemini 2 or Gemini 1?</a>
		</td>
	</tr>
	<tr>
		<td class="style6"><br />
		<a href="#Q17">17.&nbsp;&nbsp;&nbsp;&nbsp;How to test the Gemini-1 guider input circuit.</a>
		</td>
	</tr>

	<tr>
		<td class="style6">
		<br /><a href="#Q18">18.&nbsp;&nbsp;&nbsp;&nbsp;What type of Battery does the Gemini 1 and Gemini-2 units use?</a>
		</td>
	</tr>
	<tr>
		<td class="style6">
		<br /><a href="#Q19">19.&nbsp;&nbsp;&nbsp;&nbsp;Suggested replacement for the hand controller cable for Gemini-1.</a>
		</td>
	</tr>

	<tr>
		<td class="style6">
		<br /><a href="#Q20">20.&nbsp;&nbsp;&nbsp;&nbsp;Extending the battery life of the 3V battery in an Gemini-1. 
		This will also possibly help fix CMOS resets.&nbsp; This is a copy of message 3584 from the Gemini_Users Group.</a>
		</td>
	</tr>
	<tr>
		<td class="style6">
		<br /><a href="#Q21">21.&nbsp;&nbsp;&nbsp;&nbsp;Some sources of the Gemini-1 Power plug.</a>
		</td>
	</tr>

	<tr>
		<td class="style6">
		<br /><a href="#Q22">22.&nbsp;&nbsp;&nbsp;&nbsp;What does it take to add a second communication port to the Gemini Controller.</a>
		</td>
	</tr>

	<tr>
		<td class="style6">
		<br /><a href="#Q23">23.&nbsp;&nbsp;&nbsp;&nbsp;Suggested replacement for the 4 pin Gemini-1 CONN CIRCULAR DIN 4 PIN MALE 
		power connector.</a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="style6">
		<a href="#Q24">24.&nbsp;&nbsp;&nbsp;&nbsp;How to replace the 
		encoder in the 
		original Losmandy synchronies motor, by Rainer Ehlert.</a>
		</td>
	</tr>
	<tr>
		<td class="style6">
	...
	<tr>
		<td class="style6">
		<a href="#Q25">25.&nbsp;&nbsp;&nbsp;&nbsp;Part numbers for the slide power switches on the Gemini-1 units</a>
		</td>
	</tr>
	...
	<tr>
		...
		<a name="Q1"></a>1.&nbsp;&nbsp;&nbsp;Warning about parking the mount and leaving power on?
		</td>
	</tr>
	<tr>
		<td class="style6">
			<br />Answer: WARNING: The Gemini-1 has several Startup modes. If is your habit of 
	...
	<tr>
		<td class="style6-Yellow"><br />
			...
			<a name="Q2"></a>2.&nbsp;&nbsp;&nbsp;Why does the Gemini Stop and wait for startup 
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q3"></a>3.&nbsp;&nbsp;&nbsp;&nbsp;What is a ground loop and how can you test for one?
		</td>
	</tr>
	<tr>
		<td class="style6">
		...
		<a href="downloads/pdf/ground-loops.pdf" target="_blank" title="Ground Loops ">Ground Loops Article</a>
		<span class="style6-Yellow">Answer for how do you test for one.</span><br />
		<Span class="style6">Ground loops and power supplies are tricky thing.
		...
		the power suppy input is not isolated from the power supply output.
		<br />
		...
		would be the Gemini ground input pins. This is not easy to alway do.
		The next best is opto or magnetic isolated inputs to the Guider and
		RS232 inputs.
		<br />
		<br />

		If you do do a central ground between your devices, consider puting in a
		ground rod at least 8 ft deep next to the central point into the
		ground. This can help prevent static damage.<br /><br />
		...
		course I manufactured my own.<br />
		<br />
	...
	<tr>
		<td class="style6-Yellow"><br />
		<a name="Q4"></a>4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;How do you disable the Gemini modeling, to use T-Point or ACP
		</td>
	</tr>
	<tr>
		<td class="style6" style="height: 4px">
			...
			see a check box with &quot;Sync Mode Affects Model (Additional Align)&quot;. Make sure<br />
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q5"></a>5.&nbsp;&nbsp;&nbsp;Is it possible to use more than one USB-serial adapter at 
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q6"></a>6.&nbsp;&nbsp;&nbsp;&nbsp;How do you install the ASCOM Driver in TheSKY6?
		</td>
	</tr>
	<tr>
		<td class="style6">
			Answer:  If you downloaded the 
			<a href="http://ascom-standards.org/Downloads/Plugins.htm">TeleAPI package</a> from the ASCOM web site, Downloads
			...
			ASCOM-compliant telescopes via TheSky's "TeleAPI" feature.<br />
			<br />
			<span class="style6-Yellow">Installation</span>
			<ol class="style6">
			<li>Rename the file C:\Program Files\Common Files\System\TeleAPI.dll
			to TeleAPI-Original.dll</li>
			<li> Copy the ASCOM TeleAPI.dll to C:\Program Files\Common Files\System\TeleAPI.dll</li>
			</ol>
			<span class="style6-Yellow">One-time Telescope Setup</span>
			<ol class="style6">
			<li>In TheSky, Telescope menu, select Setup...</li>
			<li> In the Control System box, select "Telescope API"</li>
			<li> Click Settings... to open the ASCOM Telescope Chooser and
			select the ASCOM compliant telescope you wish to use.</li>
			<li> Now click Properties... in the Chooser, which will display
			the settings window for the telescope type you just chose. Make
			adjustments as your telescope needs.</li>
			<li> Close all windows including the TheSky Telescope Setup
			window by clicking OK or Close. Do not click any Cancel buttons.</li>
			</ol>
			<span class="style6-Yellow">Operation</span>
			<ol class="style6">			
			<li>Make sure both your telescope and TheSky are set for the same
			geographic location and time.</li>
			<li>In TheSky, Telescope menu, select Link->Establish. You should
			see the cross-hairs indicating where the telescope is pointing.</li>
			<li>Please follow steps (1) and (2) exactly. The file does not go into "The Sky 6
			folder in the program files"...</li>
			</ol>
			Also please see "<a href="http://ascom-standards.org/FAQs/TheSky.htm" target="_blank">Working 
			With TheSky</a>" on the ASCOM site (the link is in the
			text describing TeleApi) at
			<a href="http://ascom-standards.org/FAQs/TheSky.htm">http://ascom-standards.org/FAQs/TheSky.htm</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			(the above steps are a direct quote from Bob Denny in the
			<a href="http://groups.yahoo.com/neo/groups/ASCOM-Talk/" target="_blank">
			ASCOM-Talk Users Group</a>).<br />		</td>
	</tr>

	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q7"></a>7.&nbsp;&nbsp;&nbsp;&nbsp;How do you determine the Com Port of a connected USB 
	...
	<tr>
		<td class="style6">
			...
			<ul>
				<li class="style6">First click on the Start Tab at the bottom left of the screen.</li>
			    <li class="style6">Then in the menu that pops up, Right click &quot;My Computer&quot;, 
			    then scroll down and select &quot;Properties.&quot; You should now have window up that 
			    says &quot;System Properties&quot;.</li> 
				<li class="style6">There is a &quot;Hardware Tab,&quot; click that. You now have several 
				selection buttons, click the one that says &quot;Device Manager&quot; This will bring up 
				a window that has a list of all the hardware in your computer.</li> 
				<li class="style6">Scroll down to the one that says Ports(Com &amp; LPT). Click on the + 
				sign to the left. (this will open the list of ports. If you have a USB to Serial Adapter 
				plugged in and powered up, you should see it in the list. Double Click on it.</li>
				<li class="style6">This will open a box that has Several Tabs across the top. Select the 
				one called &quot;Port Setting&quot; This is where you can set the Communications baud 
				rate data bits etc.</li>
				<li class="style6">Click on the button that says &quot;Advanced...&quot; A new window 
				will open labeled Advanced Setting for Com(number of what the port is presently).</li>
				<li class="style6">At the bottom you will also see a selection box label &quot;Com 
				Port Number&quot; If you click on this you will see a list of all your com ports and 
				if they are empty or not.</li>
				<li class="style6">You can assign the USB to serial Adapter to any of the empty ports 
				...
				no longer being used. Close all windows. </li>
			</ul>
		</td>
	</tr>
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q8"></a>8.&nbsp;&nbsp;&nbsp;&nbsp;What is the different between the old and new 
			auto-guider ports?
		</td>
	</tr>
	<tr>
		<td class="style6">
			...
			<b>Note: </b>The autoguider port is only active in the Photographic Mode and All-
			Speeds Mode of the Gemini system. Selecting the Visual Mode disables Guiding
			and therefore the Autoguider Port.
			<br />
			More from the manual: <br />
			<br />
			
			<b>4.2.2 Manual Guiding</b><br />
			...
			In either case, you will need to make sure that the Hand Controller is set to either the Photographic or All-Speeds Mode.<br />
			<br />
			<b>4.2.3 Connecting an Autoguider to an Older Gemini:<br />
			4.2.3.1 Connecting an Autoguider with Relay Output<br />
			</b> 
			...
			Gemini Users Manual <br /><b>42
			4.2.3.2 Connecting an Autoguider with TTL Output:<br /></b>
			...
			compatible with the newer Gemini. <br />
			...
			<a href="http://www.store.shoestringastronomy.com/products_gp.htm" target="_blank">
			http://www.store.shoestringastronomy.com/products_gp.htm</a>&nbsp; if you 
			...
			have a SBig camera will not work.<br />
		</td>
	</tr>

	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q9"></a>9.&nbsp;&nbsp;&nbsp;&nbsp;How do you get Windows 2000, XP, Vista &amp; Win7 to 
	...
	<br />Now if you expand the section on COM ports, all the COM ports 
		...
		<a href="%22http:/www.fettesps.com/how-to-remove-com-ports-which-are-in-use/">"http:/www.fettesps.com/how-to-remove-com-ports-which-are-in-use/</a>
		<br /><br />
	</td></tr>

	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q10"></a>10.&nbsp;&nbsp;&nbsp;What are the changes between L4V1.02 and 
			L4V1.04 EPROMS?
		</td>
	</tr>
	<tr>
		<td class="style6">
			Answer:&nbsp; This version has the following updates over L4V1.02:<br />
			<ol>
				<li>Test for a defective autoguider input chip. Symptom: Gemini freezes after GPS readout. 
				V1.04 checks this condition, a warning is displayed and operation is continued even 
				if the chip is defective. A clearer explaination: Some brands of cameras, when un-powered 
				...
				to Losmandy please. However if you are  getting this message with nothing attached, then there is a very good possibility that your Auto-Guider chip is bad, and then you would want to contact Losmandy.</li>
				<li>Test for a defective serial port driver chip. A warning is displayed.</li> 
				<li>PEC counter is restored correctly at a Warm Restart.</li>
			</ol>
		</td>
	</tr>
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q11"></a>11. How do you determine if the RS232 chip in the Gemini is bad?
		</td>
	</tr>
	<tr>
		<td class="style6">
			<img alt="C21 in Gemini Controller" height="195" src="images/C21.jpg" style="float: left" width="300" class="auto-style5" />
			Answer:&nbsp;&nbsp; Please read all this paragraph before attempting to test. 
			The problem is normally with the negative voltage pump in the 
			IC.&nbsp;This normally only takes out the transmit side of the chip 
			(sending signals to the PC) and leave the receive side good. So if 
			you cannot connect to a PC, but can connect a GPS, and receive GPS 
			updates, this is a good indication also the negative voltage pump is 
			bad. The sure fire test requires voltage testing.&nbsp; You can check 
			this out if you have a good Voltmeter.&nbsp; Please do this only if you 
			feel comfortable doing this as you do it at your OWN RISK. The cap 
			number is C21 in the newer boards with the round motor cables. 
			Measure across this cap with you voltmeter with the Gemini powered 
			up.&nbsp; It is best if you have a friend do the meter reading while you 
			hold the leads.&nbsp; Micro-leads is highly recommended for this.&nbsp; The 
			lead closest to the IC is the negative lead. The side closest to the 
			RJ22 connectors is the ground side.&nbsp; This cap comes off of Pin 7 of 
			the IC, which should be marked with 3221 if I remember correctly.&nbsp; 
			If you do not get a 5 Volt reading or close to that then the IC has 
			gone bad (or been put to sleep, see note below) and needs to be 
			replaced.&nbsp; The Gemini is sensitive&nbsp; to ground loops, and they can 
			take this IC out.&nbsp;&nbsp; This has been the problem in all the cases I 
			have found except one. That had a bad cap and broken trace.&nbsp; Please 
			NOTE that this chip has an auto sleep mode that can also shut down 
			the transmit part of the IC. If the IC has shut down the transmit 
			part of the IC to save power, this voltage will also measure zero. 
			To wake up the IC, ask the Gemini to get GPS data, or send it a 
			command such as trying to connect using GCC. Any command that 
			requires the Gemini to send a reply should wake the IC up. <br />
			When this RS-232 chips in the Gemini-1 units go bad, it is normally the
			negative pump that goes bad.
			This produces the -5V power to allow the signal that this chip put out,
			to go from -5V to +5V when working correctly.  Now when the negative
			pump goes bad, there is no -5V.
			This means that the signal can only go from 0V to +5V.  It will eventually
			draw more and more current.
			It also gets very hot.  It will someday destroy itself, but it will take
			quite a bit of time.  I have seen
			where one actually burnt a hole in the board, destroying the traces
			underneath it. <br /><br />

			I always recommend replacing it, if you can.

		<br />
			<br />
			<img alt="" height="542" src="gemini-images/schematic/serial.jpg" width="869" />
			</td>
	</tr>

	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q12"></a>12.&nbsp;&nbsp;Can you run the Gemini without the motors connected safely?
		</td>
	</tr>
	<tr>
		<td class="style6">
			Answer:&nbsp;&nbsp; Yes you can power up the Gemini without the motors connected.  You will get motor stall/stopped errors.  You can stop these errors by putting the Gemini in the terrestrial mode.<br />
	...
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q13"></a>13.&nbsp;&nbsp;&nbsp;What will cause the Gemini to shut down 
			the handcontroller or not boot?
		</td>
	</tr>
	<tr>
		<td class="style6">
			<img alt="F2 in Gemini Controller" height="195" src="images/F2.jpg" style="float: left" width="300" class="auto-style6" />
			...
			See
			<a href="https://groups.io/g/Gemini_users/files/Gemini%201%20PCB%20parts">
			Gemini Parts description</a> in Gemini_Users group.<br />
			<br />If the Gemini-1 will not boot, it could be U3 gone bad.  This chip's 
			pin out is really simple. 
			Pin 1 is GND, pin2 is +5V and pin 3 is its RESET\ signal, so the main CPU waits for pin 3 to get to high 
			level. To check if U3 is defective you could solder it off and look if 
			the Gemini boot process proceeds without it. If yes, you should 
			definitely replace the chip, since it is needed for voltage brown-out 
			detection, too. This is necessary not only for a clean startup but also 
			to save all the data for Warm (Re)Starts.  Its part number is MPC809.
		</td>
	</tr>

	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q14"></a>14. &nbsp;&nbsp;&nbsp;&nbsp;What does the red dots on the hand controller mean 
			during boot?
		</td>
	</tr>
	<tr>
		<td class="style6">
			...
			progress and conditions<br />
			detected.<br />
			<br />
			1st dot: internal resources and display initialized<br />
			2nd dot: power good, voltage stabilized<br />
			3rd dot: SRAM accessible (otherwise &quot;SRAM failure !&quot; will be displayed)<br />
			X: the content of the SRAM was reset to default values.<br />
			R: RTC was reset (&quot;RTC malfunction&quot; displayed if RTC is not<br />
			working)<br />
			4th dot: RTC initialized<br />
			5th dot: SRAM values loaded.<br />
			<br />
			&quot;AG port defect ? &quot; will be displayed if one or more AG signals are active.<br />
			<br />
			The X is to be expected after a version change, battery change, at low<br />
			battery voltage and so on.<br />
			Once it appears, a &quot;CMOS reset&quot; string is appended to the startup<br />
			message, too.<br />
			Since the initializing is done by the same subroutine as used by the<br />
			Setup...Reset Defaults menu point,<br />
			there is no need to take the battery out to renew the SRAM content.<br />
			<br />
			A side effect of pulling the battery out is that the RTC chip will stop<br />
			working after a while and may then be<br />
			initialized at the next startup. In case of problems you may first check<br />
			and maybe set the UTC date and time and the ALARM time, too.<br /> </td>
			</tr>
	</table>
	
	<table align="center" style="width: 900px">
		<tr>
			<td width="450px">If the second dot is not displayed and the boot process stops, the board
			...
			<br />
			U3, 
					(image to the right) a MCP809-450 Voltage monitor can also keep the Gemini-1 from
			booting past the first dot on the Deluxe Hand controller.
			
			This IC is used to shut down the system (a brown-out detector) and let values
			be stored so that Warm Restart works properly. About the
			only way to test for U3 being bad is to remove it.
			</td>
			<td>
				<img alt="" height="291" src="gemini-images/faq/U3.jpg" width="433" />
				</td>
		</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			...
			There is a unused connection from the battery to an analogue input pin<br />
			of the CPU to check the voltage - R32 was removed since the CPU chip<br />
			drew some current from the battery while being powered off, shortening<br />
			battery life.<br />
			<br />
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q15"></a>15.&nbsp;&nbsp;&nbsp;&nbsp;How do you measure the CMOS RAM chip 
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			<a href="images/GeminiPCB3-Batt.jpg">
			<img src="images/GeminiPCB3-Batt_small.jpg" height="298" style="float: left" width="300" class="auto-style6" /></a>
			Answer:&nbsp;&nbsp; You would need a voltmeter to measure 
			accross pins 16 and 32 of the Static Ram chip.&nbsp; This is done with power 
			...
			Of course the Ram chip could also be bad, and pulling the voltage down.</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			<img alt="" height="569" src="gemini-images/G1_images/Battery.jpg" style="float: left" width="468" class="auto-style6" />Note 
			that R32 and U21 are not on the PCB. The bottom part of the 
			schematic to the left is the Static Ram Chip U9 which is also 
			pictured extreme left on the PCB.<br />
			All of the +VB connect together.&nbsp; VCC is +5V.<br />
			Also note that the battery type in the schematic is shown as 
			CR2354 but the schematic is the same for units with battery type CR2032.</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q16"></a>16.&nbsp;&nbsp;&nbsp;How should the guide cable from a ShoeAstronomy GPUSB be wired for the Gemini 2 or Gemini 1? 
				</td>
		</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			...
			<a href="http://www.store.shoestringastronomy.com/" target="_blank">ShoeStringAstronomy</a> that tells how to make the cable that goes from the 				GPUSB or GPUSB-AH into the Gemini-2 or Gemini-1.  Note that only the GPUSB is 
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q17"></a>17.&nbsp;&nbsp;&nbsp;How to test the Gemini-1 guider input circuit. 
		</td>
	</tr>

	<tr>
		<td class="style6">
			<a href="images/G1-GuiderInputcircuit.JPG" target="_blank">
			<img alt="" class="auto-style2" height="261" src="images/thumbnails/G1-GuiderInputcircuit_small1.JPG" style="float: left" width="400" /></a>				Answer: Here is a schematic of the Gemini-1 input guider circuit.&nbsp;Note 
			...
			(74HC04 a SOIC14 Hex Inverter buffer SMD package.&nbsp;) (In the Gemini-1 units with the RJ style motor connectors, 
			...
			helps eliminate your problems.</td>
	</tr>
	...
	<tr>
		<td class="style6-Yellow">
		<a name="Q18"></a>18.&nbsp;&nbsp;&nbsp;What type of Battery does the Gemini 1 and Gemini-2 units use? 
		</td>
	</tr>
	<tr>
		<td class="style6">
			...
			for the processor that is being used in the Gemini-2 units.</td>
	</tr>
	<tr>
		<td class="style6-Yellow">&nbsp;
		</td>
	...
	<tr>
		<td class="style6-Yellow"><a name="Q19"></a>19.&nbsp;&nbsp;&nbsp;A suggested hand controller cable replacement for the Gemini-1. 
		</td>
	</tr>
	<tr>
		<td class="style6">
			Answer: A suggested replacement is available from 
			<a href="http://cablewholesale.com" target="_blank">http://cablewholesale.com</a> with part number 10D2-01210
			</td>
	</tr>
	<tr>
		<td class="style6-Yellow">&nbsp;
	...
	<tr>
		<td class="style6-Yellow"><a name="Q20"></a>20.&nbsp;&nbsp;&nbsp;Extending the battery life of the 3V battery in an Gemini-1. 
	...
	<tr>
		<td class="style6">
			Answer:
						I (René) can offer a solution now.<br />
						...
						for the electronically inclined:<br />
						<br />
						...
						boards, one of them had CMOS Resets. All work fine.<br />
			Scott has put out a
			<a href="https://www.youtube.com/watch?v=5itKqp0TDaM" target="_blank">
			movie</a> on changing the battery.<br />
						</td>
				</tr>
		<tr>
		<td class="style6">
		...
		<tr> 
		<td class="style6-Yellow"><a name="Q21"></a>21.&nbsp;&nbsp;&nbsp;Some sources of the Gemini-1 power plug. 
		</td>
	</tr>
	<tr>
		<td class="style6">
			...
			Users Group&nbsp;
			<ol>
				<li>The orginal was a Lumberg Plug Like 
				<a href="http://au.rs-online.com/web/p/din-connectors/0491015/?searchTerm=491-015&amp;amp;relevancy-data=636F3D3126696E3D4931384E525353746F636B4E756D6265724D504E266C753D656E266D6D3D6D61746368616C6C26706D3D5E5C647B337D5B5C732D2F255C2E2C5D5C647B332C347D2426706F3D313426736E3D592673743D52535F53544F434B5F4E554D4245522677633D4E4F4E45267573743D3439312D30313526" target="_blank">this</a></li>
				<li>An alternative is
				<a href="http://au.rs-online.com/web/p/din-connectors/4849326/?searchTerm=484-9326&amp;amp;relevancy-data=636F3D3126696E3D4931384E525353746F636B4E756D6265724D504E266C753D656E266D6D3D6D61746368616C6C26706D3D5E5C647B337D5B5C732D2F255C2E2C5D5C647B332C347D2426706F3D313426736E3D592673743D52535F53544F434B5F4E554D4245522677633D4E4F4E45267573743D3438342D3933323626" target="_blank">
				this</a></li>
				<li>or
				<a href="http://au.element14.com/lumberg/0131-04/plug-free-din-4way/dp/1814820?ost=1814820" target="_blank">
				this</a> </li>
				<li>or
				<a href="http://au.element14.com/deltron-components/610-0400/plug-din-screened-4pole/dp/1193847?ost=1193847">
				this</a></li>
				<li>or
				<a href="http://www.mouser.com/ProductDetail/Switchcraft/09BL4MX/?qs=sGAEpiMZZMv0W4pxf2HiV6f3hkP%252bo%2f4NSmRP0e9Hw%252bk%3d">
				this in USA</a></li>
			</ol>
		</td>
				</tr>
	...
	<tr>
		...
		<a name="Q22"></a>22.&nbsp;&nbsp;&nbsp;What does it take to add a second 
	...
	<tr>
		<td class="auto-style4">
			...
			<a href="http://www.eterlogic.com/Products.VSPE.html" target="_blank">VSPE</a>. 
			With this driver, you can add any non-ASCOM program and have it talk to the 
			Gemini in parallel with the ASCOM programs.&nbsp; <br />
			This question used 
			to be about the USB/RS232&nbsp; Isolated to Gemini-1 HandController 
			adapter.&nbsp; These units are no longer being manufactured.&nbsp; 
			Here are some suggestions for Isolated adapters substitute and a USB 
			to DB15 adapter to provide a 2nd communications port into the Gemini 
			1.<br />
			<ol><li>USB to USB Isolated adapters:</li>
				<ul>
				<li>
				...
				mouser.com</a></li>
				<li>
				<a href="http://www.olimex.com/dev/usb-iso.html" target="_blank">http://www.olimex.com/dev/usb-iso.html</a>
				</li></ul>
			</ol>
			<ol start="2">
				<li>USB to RS232 Isolated adapter:
				</li>
				<ul>
				<li><a href="http://www.startech.com/" target="_blank">http://www.startech.com</a> and search for 
				<a href="http://www.startech.com/Cards-Adapters/Serial-Cards-Adapters/1-Port-FTDI-USB-to-Serial-RS232-Adapter-Cable-with-Optical-Isolation~ICUSB2321FIS" target="_blank">ICUSB2321FIS</a></li>
				<br /><br />
				</ul>
				<li>You can also make your own USB cable that will plug into the 
				DB15 hand controller port and provide a second Virtual Serial Port 
				using a cable from 
				<a href="http://www.ftdichip.com" target="_blank">
				http://www.ftdichip.com</a>.&nbsp; The cost should be less than 
				...
				<ul>
					...
					<li>Here is the
					<a href="2nd_Communication_Port_Cable.php" target="_blank">
					instructions</a> to make the cable.</li>
				</ul>
				</li>
			</ol>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q23"></a>23.&nbsp;&nbsp;&nbsp;Suggested replacement for the 4 pin Gemini-1 CONN CIRCULAR DIN 4 PIN MALE 
		power connector. 
		</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			Answer: 
			DigiKey Electronics still sells a part Called
			<a href="http://www.digikey.com/product-search/en?keywords=CP-1040-ND" target="_blank">
			CONN CIRCULAR DIN 4 MALE</a> There part number is CP-1040-ND or
			<a href="http://www.mouser.com/" target="_blank">http://www.mouser.com/</a> 
			and search for
			<a href="http://www.mouser.com/Connectors/Circular-Connectors/_/N-76q5a?Keyword=SD-40&amp;FS=True" target="_blank">
			490-SD-40</a></td>
	</tr>
</table>
<table  align="center" style="width:900px">
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q24"></a>24.&nbsp;&nbsp;&nbsp;How to replace the encoder in the original Losmand 
		synchronous motor, by Rainer Ehlert.</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6-Yellow"><br />
			<a name="Q25"></a>25.&nbsp;&nbsp;&nbsp;Part numbers for the slide power switches on the Gemini-1 units</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		<td class="style6">
			Answer:&nbsp;&nbsp; These switches are from CK switches.&nbsp; The 
			original switches has gold contacts that is rated only are 0.4amps.&nbsp; 
			The part number is:&nbsp;	611-1101M2S3CBE2  Mouser Electronics has them 
			<a href="http://www.mouser.com/ProductDetail/CK-Components/1101M2S3CBE2/?qs=%2fha2pyFaduievO2MBJ4ukl24B1kJ7hXL8mWWSlRL16A3YfTGGMu%252bSQ%3d%3d" target="_blank">here</a> 
			.&nbsp; They also carry a silver contact version that is rated at 
			6.0 amps.&nbsp; It's part number is 611 - 1101M2S3CQE2.&nbsp; Mouser 
			Electronic has these
			<a href="http://www.mouser.com/ProductDetail/CK-Components/1101M2S3CQE2/?qs=%2fha2pyFaduievO2MBJ4ukrRaAibbLGrwloYg4ft4shmwJlz9aFHhig%3d%3d" target="_blank">here</a>.&nbsp; I selected the silver myself for replacing mine.</td>
	</tr>
</table>
...
<table  align="center" style="width:900px">
	<tr>
		...
		Page last updated on Sept 16, 2017
		</td>
	</tr>
</table>

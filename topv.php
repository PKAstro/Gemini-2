...
<ul>
    ...
    <ul>
     ...
     <li><!--[if IE]><!--><a class="ajxsub" href="#"><!--<![endif]-->Cable Wiring
      ...
      <ul>
       ...
       <li class="slast"><a href="https://gemini-2.com/handcontroller-cable-ends.php" target="_blank">Hand Controller Cable</a></li>
      </ul>
      <!--[if lte IE 6]></td></tr></table></a><![endif]-->
     </li>
 ...
 <li><!--[if IE]><!--><a class="ajxsub" href="#"><!--<![endif]-->Help&nbsp;Topics
  ...
  <ul>
   ...
   <li><a href="https://gemini-2.com/tips.php" target="_blank">Gemini  1 and  2 Tips</a></li>

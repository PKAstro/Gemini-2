...
<table style="width: 750px" align="center">
	...
	<tr>
		<td class="style6"><br />
		This guide will help you get the Ethernet connection working 
	...
	<tr>
		<td class="style6">
		<span class="style3">Before we get started, You must be able to access the 
		...
		<br />
		If you passed the above test, lets get started.  Now these instructions only cover configuring the Ethernet in the ASSOM Gemini.net 
		driver. You will need to see the 
		<a href="http://gemini-2.com/Gemini2_drivers/Gemini_Telescope_Net_Installation_and_Operation.pdf" target="_blank">HELP</a> guide included inside the ASCOM 
...
<table style="width: 750px" align="center">
	...
	<a name="configuretelescope"></a>
		...
		The above setup menu is what you will get if the Gemini-2 has not been detected.  Notice you can still see 
		...
		<img alt="" height="581" src="gemini-images/ascom/config-ethernet.jpg" width="750" class="auto-style3" usemap="#ImgMap1" />
		<br />
...
<table  align="center" style="width:750px">
	<tr>
		...
		Page last updated on June 21, 2018</td>
	</tr>
</table>
</body>

...
<title>Semi Automatic Modeling West 11</title>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="308, 512, 443, 593" href="En-SAW-12.php" shape="rect" />
		</map>
		<img alt="" height="611"src="En-Images/En-SAW-11.jpg" width="450"usemap="#ImgMap0" /></td>
		<td width="10px"></td>
		<td class="style6">Notice that you only have only one or 2 entries for the Error Index.&nbsp; 
		...
		<br />
		Please hit Back for this Demo</td>
	</tr>
</table>

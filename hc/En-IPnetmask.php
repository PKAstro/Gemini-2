...
<table align="center" style="width: 900px">	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="354, 506, 441, 584" href="En-networkmenu.php" shape="rect" />
		</map>
		<img height="611"src="En-Images/En-netmask.jpg" usemap="#ImgMap0" width="450"/></td>
		...
		<br />
		In just 
		about all cases the net mask should be set to 255.255.255.0<br />
		<br />
	</td>
	</tr>
</table>

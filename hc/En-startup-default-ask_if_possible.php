...
<table align="center" style="width: 900px">	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="362, 610, 520, 713" href="E018.php" shape="rect" />
			<area coords="13, 513, 275, 597" href="En-startup-restarting-ask_if_possible.php" shape="rect" />
			<area coords="377, 203, 24" href="En-startup-default-warm_start.php" shape="circle" />
			<area coords="370, 300, 24" href="En-startup-default-warm_restart.php" shape="circle" />
			<area coords="373, 113, 24" href="En-startup-default-cold_start.php" shape="circle" />
			<area coords="309, 516, 438, 598" href="E018.php" shape="rect" />
		</map>
		<img height="611"src="En-Images/En-defaultstartupmode_askifpossible.jpg" width="450"usemap="#ImgMap0" /></td>
		
		<td width="10px"></td>
		<td class="style6">
		This is where you can set the default startup mode.  If you select "Ask, if Possible" then the 
		Gemini-2 will prompt you for the startup mode, unless it determines a Cold Start is the only possible mode.<br />
		<br />

...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap4" name="ImgMap4">
				<area coords="306, 520, 438, 598" href="E020.php" shape="rect" />
				<area alt="" coords="340, 426, 386, 472" href="En-hcdisplay_rotate.php" target="_self"  shape="rect" />
		</map>
		<img height="611"src="En-Images/En-hc_display_menu.jpg" usemap="#ImgMap4" width="450"/>
		<br /><span class="style3">A word of caution.&nbsp; You cannot 
		...
		distinguished.
		<br /><br /> <span class="style3">Note: for these setting to stick through power off and 
		back on, use the back button, then store setting.</span><br />
		<br />
...
<table  align="center" style="width:900px">
	<tr>
		...
		Page last updated on June 20, 2018
		</td>
	</tr>
</table>

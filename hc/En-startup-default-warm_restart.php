...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="13, 513, 275, 597" href="En-startup-restarting-warm_restart.php" shape="rect" />
			<area coords="372, 395, 24" href="En-startup-default-ask_if_possible.php" shape="circle" />
			<area coords="374, 205, 24" href="En-startup-default-warm_start.php" shape="circle" />
		...
		</map>		<img height="611"src="En-Images/En-defaultstartupmode_warm_restart.jpg" width="450"usemap="#ImgMap0" /></td>	
		
		<td width="10px"></td>
		<td class="style6">
		This is where you can set the default startup mode.  If you select "Ask, if Possible" 
		then the Gemini-2 will prompt you for the startup mode, unless it determines a Cold Start is the only possible mode.<br />
		<br />

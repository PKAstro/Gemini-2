...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="335, 455, 425, 559" href="E019A.php" shape="rect" />
		</map>
		<img alt="" height="611"src="En-Images/E009.jpg" width="450"usemap="#ImgMap0" /></td>
		<td width="10px"></td>
		...
		with your latitude and longitude.&nbsp; This offset can be in whole hours, Half hours 
		(entered as :30), quarter hours (Entered as :15), or even in minutes. See the link 

...
<title>Semi Automatic Modeling East 5</title>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="305, 517, 434, 591" href="En-SAE-06.php" shape="rect" />
		</map>
		<img height="611"src="En-Images/En-SAE-5.jpg" width="450"usemap="#ImgMap0" />
		<br/>
		<ul class="style6"><li>Polar Axis is in ArcSec.</li>
			<li>Non Perpendicularity is in ArcSec</li>
			<li>Counterweight Flexure is in ArcSec</li>
		</ul></td>
		
		<td width="10px"></td>
		<td class="style6">
		<br />
		Notice that you only have only one or 2 entries for the Error Index.&nbsp; 
		Only the HA Index Error and Dec Index Error is calculated on the first 
		star.<br />
		<br />
		You have just added your first star to the East model.<br />
		<br />

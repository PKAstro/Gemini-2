...
<title>Semi Automatic Modeling West 16</title>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="315, 510, 446, 589" href="En-SAW-17.php" shape="rect" />
		</map>
		<img alt="" height="611"src="En-Images/En-SAW-16.jpg" width="450"usemap="#ImgMap0" /></td>
		<td width="10px"></td>
		<td class="style6">
		<br />
		Notice that you now also&nbsp; have 
		...
		<br />
		Please hit Back to go to the next star.</td>
	</tr>
</table>

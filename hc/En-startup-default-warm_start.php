...
<table align="center" style="width: 900px">	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="13, 513, 275, 597" href="En-startup-restarting-warn_start.php" shape="rect" />
		...
		<img height="611"src="En-Images/En-defaultstartupmode_warm_start.jpg" width="450"usemap="#ImgMap0" /></td>
		
		<td width="10px"></td>
		<td class="style6">
		This is where you can set the default startup mode.  If you select "Ask, if Possible" then the Gemini-2 will prompt 
		you for the startup mode, unless it determines a Cold Start is the only possible mode.<br />
		<br />
		...
		<br />
		If Warm Start or Warm Restart is the selected mode, then it will 
		go to 
		the main menu.
		</td>
	</tr>

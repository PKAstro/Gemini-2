...
<table align="center" style="width: 900px">	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="306, 520, 438, 598" href="En-system.php" shape="rect" />
		...
		<td width="10px"></td>
		<td class="style6">
		<span class="auto-style1">PLEASE NOTE: THE HAND CONTROLLER DOES HOT HAVE A ETHERNET PORT.</span><br /><br /><br /><br /><br /><br />
		Network Setting menu<br />
		This is where you can set up the main units network setting.&nbsp; It is also 

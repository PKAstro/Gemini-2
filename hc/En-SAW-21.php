...
<title>Semi Automatic Modeling West 21</title>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap0" name="ImgMap0">
			<area coords="316, 513, 444, 590" href="E004.php#start" shape="rect" />
		</map>
		<img alt="" height="611"src="En-Images/En-SAW-21.jpg" width="450"usemap="#ImgMap0" /></td>

		<td width="10px"></td>
		<td class="style6">
		<br />
		Notice that you only have 
		<span lang="en-us"></span>the Polar Axis errors calculated also.<br />
		<br />
		...
		<br />
		Normally the BACK button would take you to another star, but for this 
		Demo it is going to take you back to the main menu, so that you can 
		continue investigating the hand controller functions. </td>
	</tr>
</table>

		...
		<tr><td class="style6">
			<ul>
				<li>Aug 19, 2010</li><ul>
					<li>Updated HC 
					<ul>
						<li>Backlight is now dimmed to 100, 70, 60, 50, 40, 30, 20, 10, 0 
						</li>
					<li>While keeping the the PWM cycle at 100Hz so no flicker 
					of the backlight.</li>
					</ul>
					</li>
			</ul></ul>

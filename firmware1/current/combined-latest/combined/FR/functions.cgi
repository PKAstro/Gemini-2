...
t <INPUT TYPE=SUBMIT NAME="pb=1" VALUE="Activer PEC sur Démarrer la localisation">
t <INPUT TYPE=SUBMIT NAME="pb=0" VALUE="Désactiver PEC sur Démarrer la localisation">
t </form></CENTER><HR>
# -----------------------------------------------

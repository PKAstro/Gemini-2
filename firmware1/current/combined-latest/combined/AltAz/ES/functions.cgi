...
t <INPUT TYPE=SUBMIT NAME="pb=1" VALUE="Habilitar PEC el iniciar el seguimiento">
t <INPUT TYPE=SUBMIT NAME="pb=0" VALUE="Desactivar PEC el iniciar el seguimiento">
t </CENTER></form></P><HR>
# -----------------------------------------------

i pg_header.inc
t <title>Gemini Flash Storage</title>
...
t <h1 style="text-align: center;">Flash Memory</h1>
t <h2 align=center>Gemini Flash Memory Directory</h2>
...
t <p><font size="3"><br>Upload a file to the Flash root folder.</font></p>
t <form action=Flash.cgi method=POST enctype="multipart/form-data" name=fileupload>
t <p><font face="verdana"><br><br><br>Select a File to upload to Flash:<br></font>
...
t <INPUT TYPE=BUTTON VALUE="Refresh" OnClick="location='/Flash.cgi'">
t </p></form>

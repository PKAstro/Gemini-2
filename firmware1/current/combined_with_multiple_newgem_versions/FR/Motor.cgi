...
t <CENTER><H2>États du moteur et paramètres</H2></CENTER>
#
...
t </tbody></table><br></P>
#
t <P><B>Coordonnées télescopiques:</B></P>
t <P><table style="text-align: right; width: 96%; margin-left: auto; margin-right: auto;"
t border="1" cellpadding="2" cellspacing="2">
# t  <caption></caption>
t <tbody><tr><td style="width: 38%;">État de l'axe des angles de l'heure:</td>
...
t <td style="width: 38%;">Etat de l'axe de déclinaison:</td>
t <td style="width: 10%;"><input type="text" readonly style="background-color: 
t transparent; border: 0px" align=center size=20 maxsize=20
...
t <td style="text-align: right;">Position physique de l'axe de déclinaison:</td>
t <td align="center"><input type="text" readonly style="background-color: transparent; border: 0px"
t align=center size=10 maxsize=10
...
t </td></tr><tr><td><B>Contenu d'affichage précédent:</B></td><td>
c I P <input id="HP" name="HP" type="text" readonly="readonly" size=64 maxlength=64 value="%s">
t </td></tr></table></P><HR>
t <p align=center>
t <INPUT TYPE=BUTTON VALUE="Accueil" OnClick="location='/index.htm'">
t <input type=button value="Rafraîchir" onclick="updateMultiple(formUpdate)">
...
t <P><CENTER><INPUT TYPE=SUBMIT NAME=set VALUE="Définir des seuils" id="sbm">
t <INPUT TYPE=RESET VALUE="annuler">
t </CENTER>
t <p align=center>
t <INPUT TYPE=BUTTON VALUE="Accueil" OnClick="location='/index.htm'">
t <input type=button value="Rafraichir" onclick="updateMultiple(formUpdate)">
t </form>
#

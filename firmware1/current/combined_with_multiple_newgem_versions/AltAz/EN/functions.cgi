...
c R 0 <option value="0" %s>Every Move</option>
c R 1 <option value="1" %s>GoTo Command</option>
c R 2 <option value="2" %s>Explicit Wakeup</option></select>
# Here are the button definitions
...
t <INPUT TYPE=SUBMIT NAME="pe" VALUE="End PEC Replay"><BR>
t <INPUT TYPE=SUBMIT NAME="pb=1" VALUE="Enable PEC on Start Tracking">
t <INPUT TYPE=SUBMIT NAME="pb=0" VALUE="Disable PEC on Start Tracking">
t </form></CENTER><HR>
# -----------------------------------------------

...
t <INPUT TYPE=SUBMIT NAME="pe" VALUE="PEC deaktivieren"><BR>
t <INPUT TYPE=SUBMIT NAME="pb=1" VALUE="Aktivieren PEC am Beginn der Verfolgung">
t <INPUT TYPE=SUBMIT NAME="pb=0" VALUE="Deaktivieren PEC am Beginn der Verfolgung">
t </form></CENTER><HR>
# -----------------------------------------------

...
t <P><CENTER><INPUT TYPE=SUBMIT NAME=set VALUE="Setze Objektkoordinaten">
...
t </tbody></table></P>
# Here are the button definitions
t <P><CENTER><INPUT TYPE=SUBMIT NAME=set VALUE="Setze Physische Objektkoordinaten">
...
t </tbody></table>
# Here are the button definitions
t <P><CENTER><INPUT TYPE=SUBMIT NAME=set VALUE="Setze Objekt Az/H" id="sbm">
...
t <CENTER><P><select name="hc" size="1">
c h 0 <option value="0" %s>Visueller Modus</option>
c h 1 <option value="1" %s>Photo Modus</option>
c h 2 <option value="2" %s>Alle Geschwindigkeiten</option></P>
# Here are the button definitions
t <BR><P><INPUT TYPE=SUBMIT NAME=set VALUE="Setze Modus">
#t <INPUT TYPE=RESET VALUE="Undo">
t </P></CENTER></form><HR>
# -----------------------------------------------
...
c n 5 <option value="6" %s>Komet/Benutzerdefiniert</option></P>
# Here are the button definitions
t <BR><P><INPUT TYPE=SUBMIT NAME=set VALUE="W&auml;hle Nachf&uuml;rung">
t </P></CENTER></form><HR>
# -----------------------------------------------

...
t </tbody></table></P>
# Here are the button definitions
t <P><CENTER><INPUT TYPE=SUBMIT NAME=set VALUE="Enregistrer position physique">
...
t border="1" cellpadding="2" cellspacing="2"><tbody>
# t  <caption></caption>
t <tr><td style="text-align: right;">Azimut</td>
...
c h 2 <option value="2" %s>Mode toutes vitesses</option></P>
# Here are the button definitions
t <BR><P><INPUT TYPE=SUBMIT NAME=set VALUE="Enregistrer mode HC">
#t <INPUT TYPE=RESET VALUE="Annuler">
t </form></P></CENTER><HR>
# -----------------------------------------------
...
c n 5 <option value="6" %s>Comète/Réglable</option></P>
# Here are the button definitions
t <BR><P><INPUT TYPE=SUBMIT NAME=set VALUE="Enregistrer vitesse">
t </P></CENTER></form><HR>
# -----------------------------------------------
t <P><INPUT TYPE=BUTTON VALUE="Accueil" OnClick="location='/index.htm'">
t <INPUT TYPE=BUTTON VALUE="Rafraîchir" OnClick="location='/functions.cgi'">
t </FORM></CENTER></P>

...
<title>Enter Western Safty Linit</title>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<area coords="348, 505, 438, 598" href="limits.php" shape="rect" />
			</map>
			<img height="611"src="gemini-images/LimitSwitches/safetylimit-western.jpg" width="450"usemap="#ImgMap0" /></td>
	...
	<ol>
		...
		Menu-&gt;Mount-&gt;Limits-&gt;"Set Limits Here" button, to set the 
		Western Limit.</li>
		<li>
		Hit ENT to go back to the previous menu.&nbsp;
		</li>
	</ol>

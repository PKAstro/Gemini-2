...
<body style="color: #FFFFFF; background-color: #000000">
	...
	<table align="center" style="width: 900px">
		...
		<tr>
			...
			<a href="http://www.gemini-2.com/firmware1/july/combined.zip" target="_blank">combined.zip</a>&nbsp; Now 1 of the three windows should pop up 
			depending which Web browser you are using.<ul><li>If using Windows IE:
				<a _self"="" href="using_filezilla-IE.php" target="_self">click here</a> to see window. 
				Please use the Save as option and browse to C:\Gemini-2 for the 
				save location.</li>
				<li>If using Firefox: 
				<a href="using_filezilla-firefox.php" target="_self">Click here</a> to see window.</li>
				<li>If using Chrome: 
		...
		<tr>
			...
			file.<ul><li>Right mouse click on the combined.zip file.</li>
				<li>Right mouse clicl on the the 7-Zip selection</li>

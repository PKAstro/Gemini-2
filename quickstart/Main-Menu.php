...
<table align="center" style="width: 900px">
	<tr>
		<td class="h5" align="center">Quick Start Tutorial - click on green buttons to 
		Navigate</td>
	</tr>
</table>
...
<table align="center" style="width: 900px">
	<tr>
		...
		<map id="ImgMap2" name="ImgMap2">
				<area coords="162, 524, 290, 600" href="../hc/E012.php" shape="rect" />
				<area coords="305, 527, 441, 606" href="../hc/E028.php" shape="rect" />
			</map>
			<img height="611"src="../hc/En-Images/E004-coordinates.jpg" width="450"usemap="#ImgMap2" /></td>

		<td width="10px"></td>
		<td class="style6">
		This is where the Quick Start Tutorial Ends.<br />
		Hitting either the Menu or GOTO buttons will take you into the Hand 
		Controller Tutorial.<br />
		<br />
		...
		up.&nbsp; The speeds are in the same order as the speed button.
		</td>
	</tr>
</table>
<table align="center" style="width: 900px">
	<tr>
		...
		on the Gemini-1, and are multi-touch.<br />
			<br />
			I would like to suggest that you read the
			<a href="../definitions.php" target="_blank">Definitions</a> page, 
			and then go through the 
			<a href="../hc/index.php" target="_blank">Hand 
			controller tutorial</a>.&nbsp; You will also want to study the pages 
			on how to connect the mount to the 
			<a href="../ConnectingtoG2.php" target="_blank">Ethernet</a>, and get into the Web interface.</td>
	</tr>
</table>
<!--
<table align="center" style="width: 900px">

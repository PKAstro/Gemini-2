...
<body style="color: #FFFFFF; background-color: #000000;">
	...
	<table align="center" style="width: 900px">
		<tr class="style6">
			<td>
			<p>This guide will help you install the FileZilla FTP program.</p> 
			...
			<div class="style7">
				...
				<img alt="" height="486" src="gemini-images/FTP/filezilla/thumbnails/Filezilla1_small.jpg" width="900"  /></a>
			...
			<p>
				...
				Figure 2 should appear.&nbsp; Notice the the file versions of 
				FileZilla are always being updated, so the file versions you see 
				might very well be later that the ones in the next images.
			</p>
			<div class="style7">
				<a href="gemini-images/FTP/filezilla/Filezilla2.jpg" target="_blank">
				<img alt="" height="487" src="gemini-images/FTP/filezilla/thumbnails/Filezilla2_small.jpg" width="900"  /></a>
			...
			<div class="style7">
				...
				<img alt="" height="487" src="gemini-images/FTP/filezilla/thumbnails/Filezilla3_small.jpg" width="900" /></a>
			...
			<div class="style7">
				...
				<img alt="" height="487" src="gemini-images/FTP/filezilla/thumbnails/Filezilla4_small.jpg" width="900"  /></a>
			...
			<div class="style7">
				...
				<img alt=""  height="506" src="gemini-images/Routers/Filezilla11_small.jpg" width="900" />
				</a>
			...
			<div class="style7">
				...
				<img alt="" height="325" src="gemini-images/FTP/filezilla/thumbnails/Filezilla14_small.jpg" width="600"  /></a>

...
<table align="center" style="width: 80%">
	<tr>
		<td class="style6">
	<ol><li> 
		It is very important that you do as accurate&nbsp; a Counter-Weight-Down, and Pointing the 
...
<!--		<li> 
		...
		Note: This instruction is a holdover from the Gemini-1 Level 4 
		instruction manual and it may not work on the Gemini-2.</li> 
-->		<li> 
